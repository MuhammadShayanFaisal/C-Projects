...
public:
    ...
    {   
        ...
        scoreFile << name << " - Score: " << score <<" -time: "<<60-countDown<< endl;
        scoreFile.close();
        snake.Reset();
        food.position = food.GenerateRandomPos(snake.body);
        running = false;
...
int main()
{
    ...
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "Hamza Snake");
    SetTargetFPS(60);
    ...
    while (WindowShouldClose() == false)
    {
        ...
        DrawText("Hamza Snake", offset - 5, 20, 40, darkGreen);
        DrawText(TextFormat("%i", game.score), offset - 5, offset + cellSize * cellCount + 10, 40, darkGreen);
        DrawText(TextFormat("%i", game.countDown), offset + 710, offset + cellSize * cellCount + 10, 40, darkGreen);
        game.Draw();
